<script>
    ...
    import {
        CONNECTOR_TYPE_ORTHOGONAL, SnaplinesPlugin, Group
    ...
    import BpmnInspector from "./Inspector.svelte";
...
<div class="vjs-bpmn">
    <DiagramProvider>
        ...
        <div class="vjs-bpmn-canvas">
            <DiagramComponent options={diagramOptions} {url} {data} {modelOptions}>
                <ControlsComponent/>
